...
int Enemy::getattack(Enemy &enemy){
    return e_attackStrength;
}

int Enemy::gethealth(Enemy &enemy){
    return e_healthPoints;
}

int Enemy::getexperiencworth(Enemy &enemy){
