...
Character characters_list[5] = {Character(C1,Warrior), Character(C2,Magician), Character(C3,Rouge), Character(C4,Archer), Character(C5,Pirate) } ;

char main_user_name[] = "YuviVerse";
char main_user_pass[] = "TwitchTTV";
//User main_user(main_user_name, main_user_pass,characters_list);
User main_user(main_user_name, main_user_pass);
//User main_user(main_user_name, main_user_pass,characters_list[3]);
int main()
{
  ...
  //  Character new_character;
    ...
    Enemy enemies[] = { Enemy(E1_name), Enemy(E2_name, 15, 15, 15), Enemy(E3_name, 22, 5, 10), Enemy(E4_name, 20, 10, 20), Enemy(E5_name, 50, 15, 30), Enemy(E6_name, 65, 30, 50), Enemy(E7_name, 50, 35, 30)};
   ...
   // main_user.login();
    ...
    { 
        ...
        main_user.insert_character(character_name,(job)character_job,0);
